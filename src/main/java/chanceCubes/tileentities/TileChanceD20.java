...
public class TileChanceD20 extends BlockEntity
{
	...
	public static <T extends BlockEntity> void tick(Level level, BlockPos blockPos, BlockState blockState, T t)
	{
		...
		{
			Quaternionf yaw = new Quaternionf(0, 1, 0, (float) (Math.toRadians((level.getGameTime() % 10000F) / 10000F * 360F) + (0.4 + Math.pow(1.02, d20.getStage() + 1))));
			Quaternionf pitch = new Quaternionf(1, 0, 0, 0F);
