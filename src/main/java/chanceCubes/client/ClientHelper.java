...
public class ClientHelper implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		// RenderTypeLookup.setRenderLayer(CCubesBlocks.COMPACT_GIANT_CUBE,
		// RenderType.cutoutMipped());
	}

	@SubscribeEvent
	public static void onEntityRenders(EntityRenderersEvent.RegisterRenderers event) {
		event.registerBlockEntityRenderer(CCubesBlocks.TILE_CHANCE_ICOSAHEDRON,
				p_173571_ -> new TileChanceD20Renderer());
		event.registerBlockEntityRenderer(CCubesBlocks.TILE_CUBE_DISPENSER,
				p_173571_ -> new TileCubeDispenserRenderer());
		event.registerBlockEntityRenderer(CCubesBlocks.TILE_CHANCE_GIANT, p_173571_ -> new TileGiantCubeRenderer());
	}
